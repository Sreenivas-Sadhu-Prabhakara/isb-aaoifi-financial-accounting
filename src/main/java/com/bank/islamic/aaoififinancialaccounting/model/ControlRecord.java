package com.bank.islamic.aaoififinancialaccounting.model;
...
/**
 * The BIAN control record for this service domain: "AAOIFI Ledger Posting Procedure".
 *
 ...
 * to its asset type (AAOIFI Ledger Posting). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "AAOIFI Ledger Posting Procedure";
